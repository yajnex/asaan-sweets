...
const railCardClasses = {
  wide: "h-[280px] w-[320px] sm:w-[420px] md:h-[340px] md:w-[520px]",
  tall: "h-[360px] w-[280px] sm:w-[320px] md:h-[440px] md:w-[360px]",
  standard: "h-[280px] w-[280px] sm:w-[360px] md:h-[340px] md:w-[420px]",
} as const;
    ...
    <section className="section-space bg-[#f4ecde]">
      <div className="container-shell space-y-12">
        ...
        {shouldReduceMotion ? (
          ...
          <Reveal className="relative space-y-5 overflow-hidden rounded-[40px] border border-brown/10 bg-[linear-gradient(180deg,rgba(255,250,243,0.7),rgba(248,244,236,0.35))] p-4 shadow-[0_32px_78px_rgba(44,27,18,0.08)] md:p-5">
