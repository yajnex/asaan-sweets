...
export function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 px-4 pt-4 md:px-6">
      <div
        className={cn(
          "mx-auto grid max-w-[1280px] grid-cols-[52px_1fr_52px] items-center rounded-full border px-4 py-2 transition-all md:grid-cols-[56px_1fr_56px] md:px-5 lg:grid-cols-[1fr_auto_1fr]",
          scrolled || pathname !== "/"
      ...
      >
        ...
        <Link href="/" aria-label="Asaan Sweets home" className="justify-self-center">
          <BrandMark size="nav" />
        </Link>
